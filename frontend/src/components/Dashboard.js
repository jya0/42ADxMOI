    ...
    <div className="Dashboard">
      <div className="grid-container">
        ...
        <div className="grid-item item5">
          <Typography
            variant="h6"
            sx={{ fontWeight: "bold", color: "#B68A36", paddingBottom: "10px" }}
          >
            Badges
          </Typography>
        ...
        <div className="grid-item item7">
          <Typography
            variant="h6"
            sx={{ fontWeight: "bold", color: "#B68A36", marginBottom: "10px" }}
          >
            Pending Payments
          </Typography>
        ...
        <div className="grid-item item11">
          <Typography
            variant="h6"
            sx={{ fontWeight: "bold", color: "#B68A36" }}
          >
            Transactions
          </Typography>
